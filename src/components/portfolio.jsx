...
const Portfolio = () => {
    ...
    return(
        <div className="mt-20">
            ...
            <button className={`border-2 border-red rounded-lg px-6 py-3 flex items-center my-6 ${isPurple ? "bg-purple-500 text-white" : "bg-white text-black"}`} download={MercedesPoisson}>
